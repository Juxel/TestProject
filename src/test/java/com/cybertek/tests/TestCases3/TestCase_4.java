...
public class TestCase_4 {
    ...
    public void getNumOfRecords() throws InterruptedException {
    ...
    Thread.sleep(3000);
        WebElement numOfRecords=driver.findElement(By.xpath("//div[@class='pagination pagination-centered']/label[@class='dib'][3]"));
        System.out.println("Number of Records :"+numOfRecords.getText());

        String actualResult=numOfRecords.getText();

        Thread.sleep(3000);

        String str=""+numOfRows.size();
        System.out.println("Number of Rows in String: "+str);

        Thread.sleep(3000);
        //"Verify that number of calendar events is equals to number of records"
       Assert.assertTrue(actualResult.contains(str));
