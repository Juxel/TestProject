...
public class DisabledElementTest {
    ...
    public void test1(){
        ...
        Assert.assertFalse(greenRadioButton.isEnabled(),"verify that greenButton is disabled");
        ...
        public void test2(){
            ...
            System.out.println("is input enabled : "+inputBox.isEnabled()); //--> false

            inputBox.sendKeys("Mike Smith");//element not interactable
