...
public class WebTableExample {
    ...
    public void printTableSize(){
        ...
        //number os rows-without header(we prefer this)
    ...
    public void getRow(){
        ...
        for (int i = 1; i <=allRows.size(); i++) {
            ...
            System.out.println("Row path "+rowXpath);
    ...
    public void printAllCellByIndex(){
        ...
        for (int i = 1; i <= rowNumber; i++) {
            //iterate throug each cell in the table
   ...
   @Test
    ...
    public void getCellRelationToAnotherCellInSameRow(){
        ...
        //locate the email
        String xpath="//table[@id='table1']/tbody/tr[1]/td[.='John']/../td[3]"; // .. goes to parent than sibling-->/td[3]
